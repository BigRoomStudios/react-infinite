  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      1: [
          ...
          (function(global) {
            ...
            var _jsx = (function() {
                ...
                return function(t, i, o, n) {
                  ...
                  if ((i || l === 0 || (i = {}), i && r))
                    for (var s in r) void 0 === i[s] && (i[s] = r[s]);
                  else i || (i = r || {});
                  if (l === 1) i.children = n;
                  else if (l > 1) {
            ...
            var scaleEnum = require('./utils/scaleEnum'),
              ...
              Infinite = (function(e) {
                function t(e) {
                  ...
                  var o = i.recomputeInternalStateFromProps(e);
                  (i.computedProps = o.computedProps), (i.utils =
                    o.utils), (i.shouldAttachToBottom = e.displayBottomUpwards);
                  var n = o.newState;
                  return (n.scrollTimeout = void 0), (n.isScrolling = !1), (i.state = n), i;
                }
                return _inherits(t, e), _createClass(t, null, [
                ...
                ]), _createClass(t, [
                  {
                    ...
                    value: function(e) {
                      ...
                      (this.computedProps = t.computedProps), (this.utils =
                        t.utils), this.setState(t.newState);
                    }
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function(e, t) {
                      if (
                        ...
                        var i = this.getLowestPossibleScrollTop();
                        this.shouldAttachToBottom &&
                        this.utils.getScrollTop() < i
                          ? this.utils.setScrollTop(i)
                          : e.isInfiniteLoading &&
                      ...
                      var o =
                        this.state.numberOfChildren !== t.numberOfChildren;
                      if (o) {
                        var n = infiniteHelpers.recomputeApertureStateFromOptionsAndScrollTop(
                          this.state,
                          this.utils.getScrollTop()
                        );
                        this.setState(n);
                  ...
                  },
                  {
                    ...
                    value: function() {
                      ...
                      var i = {};
                      this.state.isScrolling && (i.pointerEvents = 'none');
                      ...
                      if (this.computedProps.displayBottomUpwards) {
                        var r =
                          ...
                          this.state.infiniteComputer.getTotalScrollableHeight();
                        r > 0 && (o = r - this.loadingSpinnerHeight);
                      }
                      var l =
                        void 0 ===
                      ...
                      return React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement('div', {
                            ...
                            style: infiniteHelpers.buildHeightStyle(o)
                          }),
                          this.computedProps.displayBottomUpwards && l,
                          e,
                          !this.computedProps.displayBottomUpwards && l,
                          React.createElement('div', {
                            ref: function(e) {
                            ...
                            style: infiniteHelpers.buildHeightStyle(n)
                          })
                        )
                      );
                    }
            ...
            var _initialiseProps = function() {
              var e = this;
              (this.shouldAttachToBottom = !1), (this.preservedScrollState = 0), (this.loadingSpinnerHeight = 0), (this.generateComputedUtilityFunctions = function(
                t
              ) {
                var i = {};
                if (
                  (
                    (i.getLoadingSpinnerHeight = function() {
                      var t = 0;
                      return e.loadingSpinner &&
                        (t = e.loadingSpinner.offsetHeight || 0), t;
                    }),
                    t.useWindowAsScrollContainer
                  )
                )
                  (i.subscribeToScrollListener = function() {
                    window.addEventListener('scroll', e.infiniteHandleScroll);
                  }), (i.unsubscribeFromScrollListener = function() {
                    window.removeEventListener(
                      'scroll',
                      e.infiniteHandleScroll
                    );
                  }), (i.nodeScrollListener = function() {}), (i.getScrollTop = function() {
                    return window.pageYOffset;
                  }), (i.setScrollTop = function(e) {
                    window.scroll(window.pageXOffset, e);
                  }), (i.scrollShouldBeIgnored = function() {
                    return !1;
                  }), (i.buildScrollableStyle = function() {
                    return {};
                  });
                else if (t.scrollContainerSelector) {
                  var o = document.querySelector(t.scrollContainerSelector);
                  (i.subscribeToScrollListener = function() {
                    o.addEventListener('scroll', e.infiniteHandleScroll);
                  }), (i.unsubscribeFromScrollListener = function() {
                    o.removeEventListener('scroll', e.infiniteHandleScroll);
                  }), (i.nodeScrollListener = function() {}), (i.getScrollTop = function() {
                    return o.scrollTop;
                  }), (i.setScrollTop = function(e) {
                    o.scroll(0, e);
                  ...
                  (i.subscribeToScrollListener = function() {}), (i.unsubscribeFromScrollListener = function() {}), (i.nodeScrollListener =
                    e.infiniteHandleScroll), (i.getScrollTop = function() {
                    return e.scrollable ? e.scrollable.scrollTop : 0;
                  }), (i.setScrollTop = function(t) {
                    e.scrollable && (e.scrollable.scrollTop = t);
                  }), (i.scrollShouldBeIgnored = function(t) {
                ...
                checkProps(t);
                var i = infiniteHelpers.generateComputedProps(t),
                  o = e.generateComputedUtilityFunctions(t),
                  n = {};
                return (n.numberOfChildren = React.Children.count(
                  i.children
                )), (n.infiniteComputer = infiniteHelpers.createInfiniteComputer(
                  i.elementHeight,
                  i.children
                )), void 0 !== i.isInfiniteLoading &&
                  (n.isInfiniteLoading =
                    i.isInfiniteLoading), (n.preloadBatchSize =
                  i.preloadBatchSize), (n.preloadAdditionalHeight =
                  i.preloadAdditionalHeight), (n = Object.assign(
                  n,
                  infiniteHelpers.recomputeApertureStateFromOptionsAndScrollTop(
                    n,
                    o.getScrollTop()
                  )
                )), { computedProps: i, utils: o, newState: n };
                ...
                e.setState({ isScrolling: !0, scrollTimeout: i });
                ...
                return !(
                  _isFinite(e.computedProps.infiniteLoadBeginEdgeOffset) &&
                  e.state.infiniteComputer.getTotalScrollableHeight() <
                    e.computedProps.containerHeight
                );
              }), (this.passedEdgeForInfiniteScroll = function(t) {
                var i = e.computedProps.infiniteLoadBeginEdgeOffset;
                return (
                  typeof i === 'number' &&
                  (e.computedProps.displayBottomUpwards
                    ? !e.shouldAttachToBottom && t < i
                    : t >
                      e.state.infiniteComputer.getTotalScrollableHeight() -
                        e.computedProps.containerHeight -
                        i)
                ...
                e.setState({
                  isInfiniteLoading: !0
                }), e.computedProps.onInfiniteLoad();
              }), (this.handleScroll = function(t) {
                (e.shouldAttachToBottom =
                  e.computedProps.displayBottomUpwards &&
                  t >=
                    e.getLowestPossibleScrollTop()), e.manageScrollTimeouts();
                var i = infiniteHelpers.recomputeApertureStateFromOptionsAndScrollTop(
                  e.state,
                  t
                );
                e.passedEdgeForInfiniteScroll(t) && !e.state.isInfiniteLoading
                  ? (e.setState(Object.assign({}, i)), e.onInfiniteLoad())
                  : e.setState(i);
              });
            };
            (module.exports = Infinite), (global.Infinite = Infinite);
          }.call(
            this,
        ...
        {
          './utils/checkProps': 9,
          './utils/establish-polyfills': 10,
          './utils/infiniteHelpers': 11,
          './utils/scaleEnum': 12,
          './utils/window': 13,
          'lodash.isfinite': 3,
 ...
 */
      ...
      5: [
        function(require, module, exports) {
          ...
          var _createClass = (function() {
            ...
            InfiniteComputer = require('./infiniteComputer.js'),
            bs = require('../utils/binaryIndexSearch.js'),
            ArrayInfiniteComputer = (function(e) {
              function t(e, r) {
                _classCallCheck(this, t);
                ...
                return (n.prefixHeightData = n.heightData.reduce(function(
                  e,
                  t
                ) {
                  return e.length === 0
                    ? [t]
                    : (e.push(e[e.length - 1] + t), e);
                }, [])), n;
              }
              return _inherits(t, e), _createClass(t, [
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    return e === 0 ? 0 : this.prefixHeightData[e - 1];
                  }
                },
                {
                  key: 'getDisplayIndexStart',
                  value: function(e) {
                    var t = bs.binaryIndexSearch(
        ...
        { '../utils/binaryIndexSearch.js': 8, './infiniteComputer.js': 7 }
      ],
      6: [
        function(require, module, exports) {
          'use strict';
          ...
          var _createClass = (function() {
            ...
            InfiniteComputer = require('./infiniteComputer.js'),
            ConstantInfiniteComputer = (function(t) {
              function e() {
              ...
              return _inherits(e, t), _createClass(e, [
                ...
                },
                {
                  key: 'getDisplayIndexStart',
                  value: function(t) {
                    return Math.floor(t / this.heightData);
                  }
                },
                {
                  key: 'getDisplayIndexEnd',
                  value: function(t) {
                    var e = Math.ceil(t / this.heightData);
                    return e > 0 ? e - 1 : e;
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function(t) {
                    ...
                    return Math.max(
                      0,
                      (this.numberOfChildren - e) * this.heightData
                    );
                  }
                }
              ]), e;
          ...
          var _createClass = (function() {
              function e(e, t) {
                for (var n = 0; n < t.length; n++) {
                  var a = t[n];
                  (a.enumerable =
                    a.enumerable || !1), (a.configurable = !0), 'value' in a &&
            ...
            InfiniteComputer = (function() {
              function e(t, n) {
                _classCallCheck(
                  this,
                  e
                ), (this.heightData = t), (this.numberOfChildren = n);
              }
      ...
      8: [
        function(require, module, exports) {
          'use strict';
          var opts = { CLOSEST_LOWER: 1, CLOSEST_HIGHER: 2 },
            binaryIndexSearch = function(r, t, e) {
              for (var n, o, S, a = r.length - 1, s = 0; s <= a; ) {
                if (((o = s + Math.floor((a - s) / 2)), (S = r[o]) === t))
                  return o;
                S < t ? (s = o + 1) : S > t && (a = o - 1);
              }
              return e === opts.CLOSEST_LOWER && s > 0
                ? (n = s - 1)
                : e === opts.CLOSEST_HIGHER &&
                  a < r.length - 1 &&
                  (n = a + 1), n;
            };
          module.exports = { binaryIndexSearch: binaryIndexSearch, opts: opts };
        },
        {}
      ],
      9: [
        function(require, module, exports) {
          (function(global) {
            ...
            module.exports = function(e) {
              ...
              if (
                Array.isArray(e.elementHeight) &&
                React.Children.count(e.children) !== e.elementHeight.length
              )
                throw new Error(
                  r +
        ...
        { 'lodash.isfinite': 3, react: undefined }
      ],
      10: [
        function(require, module, exports) {
          'use strict';
          Object.assign ||
            (Object.assign = require('object-assign')), Array.isArray ||
            (Array.isArray = require('lodash.isarray'));
        },
        { 'lodash.isarray': 2, 'object-assign': 4 }
      ],
      11: [
        function(require, module, exports) {
          (function(global) {
            ...
            function createInfiniteComputer(e, t) {
              var o = React.Children.count(t);
              return Array.isArray(e)
                ? new ArrayInfiniteComputer(e, o)
                : new ConstantInfiniteComputer(e, o);
            }
            function recomputeApertureStateFromOptionsAndScrollTop(e, t) {
              var o = e.preloadBatchSize,
                n = e.preloadAdditionalHeight,
                r = e.infiniteComputer,
                i = o === 0 ? 0 : Math.floor(t / o),
                a = o * i,
                p = a + o,
                l = Math.max(0, a - n),
                u = Math.min(r.getTotalScrollableHeight(), p + n);
              return {
                displayIndexStart: r.getDisplayIndexStart(l),
                displayIndexEnd: r.getDisplayIndexEnd(u)
              };
            }
            function generateComputedProps(e) {
              ...
              (t =
                typeof t === 'number'
                  ? t
                  : 0), (p.containerHeight = e.useWindowAsScrollContainer
                ? window.innerHeight
                : t), (p.handleScroll = r || function() {}), (p.onInfiniteLoad =
                i || function() {});
              var l = {
                  type: scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR,
                  amount: 0.5
                ...
                u = o && o.type ? o : l;
              typeof o === 'number'
                ? (p.preloadBatchSize = o)
                : (void 0 === u ? 'undefined' : _typeof(u)) === 'object' &&
                  u.type === scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR
                  ? (p.preloadBatchSize = p.containerHeight * u.amount)
                  : (p.preloadBatchSize = 0);
              var c = {
                  type: scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR,
                  amount: 1
                },
              ...
              return typeof n === 'number'
                ? (p.preloadAdditionalHeight = n)
                : (void 0 === d ? 'undefined' : _typeof(d)) === 'object' &&
                  d.type === scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR
                  ? (p.preloadAdditionalHeight = p.containerHeight * d.amount)
                  : (p.preloadAdditionalHeight = 0), Object.assign(a, p);
            }
            function buildHeightStyle(e) {
        ...
        {
          '../computers/arrayInfiniteComputer.js': 5,
          '../computers/constantInfiniteComputer.js': 6,
          './scaleEnum': 12,
          './window': 13,
          react: undefined
        }
