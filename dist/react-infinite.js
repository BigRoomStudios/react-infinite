          ...
          (function(global) {
                    ...
                    value: function() {
                      ...
                      return React.createElement(
                        ...
                        React.createElement(
                          ...
                          this.computedProps.displayBottomUpwards && s,
                          e,
                          !this.computedProps.displayBottomUpwards && s,
                          React.createElement('div', {
                            ref: function(e) {
            ...
            (Infinite.propTypes = {
              ...
              preloadBatchSize: PropTypes.oneOfType([
                PropTypes.number,
                PropTypes.shape({
                  type: PropTypes.oneOf(['containerHeightScaleFactor'])
                    .isRequired,
              ...
              styles: PropTypes.shape({ scrollableStyle: PropTypes.object })
                .isRequired
            ...
            var _initialiseProps = function() {
              ...
              (this.shouldAttachToBottom = !1), (this.preservedScrollState = 0), (this.loadingSpinnerHeight = 0), (this.generateComputedUtilityFunctions = function(
                ...
                var o = void 0;
                return t.useWindowAsScrollContainer &&
                  (o = window), t.scrollContainerSelector &&
                  (o = document.querySelector(t.scrollContainerSelector)), o
                  ? (
                  ...
                  : (
                      (i.subscribeToScrollListener = function() {}),
                      (i.unsubscribeFromScrollListener = function() {}),
                      (i.nodeScrollListener = e.infiniteHandleScroll),
                      (i.getScrollTop = function() {
