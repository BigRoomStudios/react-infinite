  ...
  })(
    {
        ...
        function(e, t, n) {
          (function(n) {
            ...
            var l = (function() {
              ...
              a = n.React || e('react'),
              s = n.PropTypes || e('prop-types'),
              u = e('./utils/window');
            e('./utils/establish-polyfills');
            var c = e('./utils/scaleEnum'),
              p = e('./utils/infiniteHelpers'),
              f = e('lodash.isfinite'),
                ...
                return r(t, e), l(t, null, [
                  {
                    ...
                    value: function(e) {
                      ...
                      return {
                        type: c.CONTAINER_HEIGHT_SCALE_FACTOR,
                        amount: e
                      };
                    }
                  }
                  ...
                  },
                  {
                    ...
                    value: function(e, t) {
                      ...
                      if (o) {
                        var i = p.recomputeApertureStateFromOptionsAndScrollTop(
                          this.state,
                          this.utils.getScrollTop()
                        );
                        this.setState(i);
            ...
            (h.propTypes = {
              ...
              elementHeight: s.oneOfType([s.number, s.arrayOf(s.number)])
                .isRequired,
              containerHeight: s.number,
              useWindowAsScrollContainer: s.bool,
              scrollContainerSelector: s.string,
              ...
              loadingSpinnerDelegate: a.createElement('div', null),
            ...
            var g = function() {
              ...
              (this.shouldAttachToBottom = !1), (this.preservedScrollState = 0), (this.loadingSpinnerHeight = 0), (this.generateComputedUtilityFunctions = function(
                ...
                d(t);
                var n = p.generateComputedProps(t),
                  o = e.generateComputedUtilityFunctions(t),
                  i = {};
                return (i.numberOfChildren = a.Children.count(
                  n.children
                )), (i.infiniteComputer = p.createInfiniteComputer(
                  n.elementHeight,
                  n.children
                  ...
                  i,
                  p.recomputeApertureStateFromOptionsAndScrollTop(
                    i,
                    o.getScrollTop()
                  )
                ...
                var n = p.recomputeApertureStateFromOptionsAndScrollTop(
                  e.state,
                  t
                );
      ...
      2: [
        function(e, t, n) {
          ...
          function s(e) {
            return e != null && (l(e) ? y.test(d.call(e)) : o(e) && p.test(e));
          }
          var u = '[object Array]',
            c = '[object Function]',
            ...
            b =
              m ||
              function(e) {
                return o(e) && r(e.length) && g.call(e) == u;
              };
          t.exports = b;
        },
        {}
        ...
        function(e, t, n) {
          (function(n) {
            ...
            function i(e, t) {
              ...
              return Array.isArray(e) ? new c(e, n) : new u(e, n);
            }
            function r(e, t) {
              var n = e.preloadBatchSize,
                ...
                a = l + n,
                s = Math.max(0, l - o),
                u = Math.min(i.getTotalScrollableHeight(), a + o);
              return {
                displayIndexStart: i.getDisplayIndexStart(s),
                displayIndexEnd: i.getDisplayIndexEnd(u)
              };
            }
            function l(e) {
              ...
              (t =
                typeof t === 'number'
                  ? t
                  : 0), (u.containerHeight = e.useWindowAsScrollContainer
                ? d.innerHeight
                : t), (u.handleScroll = r || function() {}), (u.onInfiniteLoad =
                l || function() {});
              var c = { type: p.CONTAINER_HEIGHT_SCALE_FACTOR, amount: 0.5 },
                f = n && n.type ? n : c;
              typeof n === 'number'
                ? (u.preloadBatchSize = n)
                : (void 0 === f ? 'undefined' : s(f)) === 'object' &&
                  f.type === p.CONTAINER_HEIGHT_SCALE_FACTOR
                  ? (u.preloadBatchSize = u.containerHeight * f.amount)
                  : (u.preloadBatchSize = 0);
              var h = { type: p.CONTAINER_HEIGHT_SCALE_FACTOR, amount: 1 },
                g = i && i.type ? i : h;
              return typeof i === 'number'
                ? (u.preloadAdditionalHeight = i)
                : (void 0 === g ? 'undefined' : s(g)) === 'object' &&
                  g.type === p.CONTAINER_HEIGHT_SCALE_FACTOR
                  ? (u.preloadAdditionalHeight = u.containerHeight * g.amount)
                  : (u.preloadAdditionalHeight = 0), Object.assign(a, u);
            }
            function a(e) {
            ...
            var s =
              ...
              u = e('../computers/constantInfiniteComputer.js'),
              c = e('../computers/arrayInfiniteComputer.js'),
              p = e('./scaleEnum'),
              f = n.React || e('react'),
              d = e('./window');
            t.exports = {
