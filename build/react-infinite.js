...
var Infinite = (function(_React$Component) {
  ...
  function Infinite(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Infinite.__proto__ || Object.getPrototypeOf(Infinite)).call(this, props)
    );
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getLowestPossibleScrollTop = function() {
    return (
      _this3.state.infiniteComputer.getTotalScrollableHeight() -
      _this3.computedProps.containerHeight
    );
  };

  this.hasAllVisibleItems = function() {
    return !(
      _isFinite(_this3.computedProps.infiniteLoadBeginEdgeOffset) &&
      _this3.state.infiniteComputer.getTotalScrollableHeight() <
        _this3.computedProps.containerHeight
    );
  };
  ...
  this.handleScroll = function(scrollTop) {
    _this3.shouldAttachToBottom =
      _this3.computedProps.displayBottomUpwards &&
      scrollTop >= _this3.getLowestPossibleScrollTop();
    ...
    if (
      _this3.passedEdgeForInfiniteScroll(scrollTop) &&
      !_this3.state.isInfiniteLoading
    ) {
